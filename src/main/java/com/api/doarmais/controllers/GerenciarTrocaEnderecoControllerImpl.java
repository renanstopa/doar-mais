...
public class GerenciarTrocaEnderecoControllerImpl implements GerenciarTrocaEnderecoController {
  ...
  @Autowired
  private ConsultaGerenciarTrocaEnderecoViewService consultaGerenciarTrocaEnderecoViewService;
  ...
  public ResponseEntity<List<BuscaGerenciarTrocaEnderecoViewModel>> buscar() {
    return new ResponseEntity<List<BuscaGerenciarTrocaEnderecoViewModel>>(
        buscaGerenciarTrocaEnderecoViewService.buscar(), HttpStatus.OK);
  }

  public ResponseEntity<ConsultaGerenciarTrocaEnderecoViewModel> consultar(Integer id) {
    return new ResponseEntity<ConsultaGerenciarTrocaEnderecoViewModel>(
        consultaGerenciarTrocaEnderecoViewService.consultar(id), HttpStatus.OK);
  }
  ...
  public ResponseEntity<ConsultaGerenciarTrocaEnderecoViewModel> aceitar(Integer id) {
    ...
    UsuarioModel usuarioModel =
        usuarioService.buscarUsuarioPorId(trocaEnderecoModel.getIdUsuario()).get();
