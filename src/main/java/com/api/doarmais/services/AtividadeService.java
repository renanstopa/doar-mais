...
public class AtividadeService {
    ...
    public List<BuscaPropostasPendentesViewModel> buscarPendentes(FiltroAnuncioRequestDto filtro) {
        CriteriaBuilder builder = entityManager.getCriteriaBuilder();
        CriteriaQuery<BuscaPropostasPendentesViewModel> query = builder.createQuery(BuscaPropostasPendentesViewModel.class);
    ...
    private void filtrarPendentes(FiltroAnuncioRequestDto filtro, CriteriaBuilder builder, CriteriaQuery<BuscaPropostasPendentesViewModel> query) {
        Root<BuscaPropostasPendentesViewModel> root = query.from(BuscaPropostasPendentesViewModel.class);
        List<Predicate> predicate = new ArrayList<Predicate>();
